...
class DataService {
    ...
    private let beginnerPlans:[Plan] = [ ]
    /*Plan( name: "Beginner full body workout routine" , numOfDays : 3  ),
    ...
    private let advancedPlans:[Plan] = [Plan(name: "Simple Mass-Gain Split", days: [ Day(day: "Monday", exerciseID: [ (.biceps , 1 ) ,
                                                                                                                              (.abs , 0 ) ] ) ]  ) ]
